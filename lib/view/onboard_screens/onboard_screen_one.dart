                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        TextStyleWidget(title: Strings.find.tr, size: 25.sp, weight: FontWeight.w700, color: MyColors.black10,),
                        TextStyleWidget(title: Strings.parking.tr, size: 25.sp, weight: FontWeight.w700, color: MyColors.primaryRed,),
                      ],
                    ),
                    TextStyleWidget(title: Strings.effortlessly.tr, size: 25.sp, weight: FontWeight.w700, color: MyColors.black10,),
                  ],
                ),
              ),
              FadeInUp(
